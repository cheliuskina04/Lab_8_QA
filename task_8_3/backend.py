...
class FileHandler(tornado.web.RequestHandler):
    ...
    def guess_type(self, path):
        # mimetypes are not reliable
        extension = Path(path).suffix.lower()
        return self.MIME_TYPES.get(extension) or \
               mimetypes.types_map.get(extension, 'text/plain')
    ...
    def get(self, path):
        ...
        content_type = self.guess_type(file_location)
